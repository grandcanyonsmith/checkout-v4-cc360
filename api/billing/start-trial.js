...
    // Safely extract affiliateId from userInfo (assuming frontend passes it here)
    const affiliateId = userInfo.affiliateId || 'none';
...
        // KEY CHANGE: Explicitly set the affiliateId metadata on the subscription
...
    // START OF DELETION/COMMENT-OUT BLOCK
    // Optional: send lead immediately to HighLevel
    // THIS BLOCK IS REMOVED/COMMENTED OUT TO PREVENT DUPLICATE GHL CALLS
    // AND RELY SOLELY ON THE STABLE VERCEL WEBHOOK.
    /*
    try {
...
    }
    */
    // END OF DELETION/COMMENT-OUT BLOCK

    // Log subscription creation
    console.log(`Trial subscription created for ${userInfo.email}, affiliate: ${affiliateId}`);
